...
class file_testing(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "File Testing", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("File Testing")
        ...
        self.settings = Qt.QSettings("GNU Radio", "file_testing")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'File.txt', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'rx.txt', False)
...
def main(top_block_cls=file_testing, options=None):
