...
class rds_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_char*1, usrp_rate,True)
        ...
        self.connect((self.blocks_throttle_0, 0), (self.gr_diff_encoder_bb_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_1, 0), (self.network_tcp_sink_0, 0))
    ...
    def set_usrp_rate(self, usrp_rate):
        ...
        self.blocks_throttle_0.set_sample_rate(self.usrp_rate)
        self.gr_frequency_modulator_fc_0.set_sensitivity(2*math.pi*self.fm_max_dev/self.usrp_rate)
